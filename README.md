...
Download and install [Microsoft C++ Build Tools](https://visualstudio.microsoft.com/visual-cpp-build-tools/), and after that install the necessary libraries following my video guide.
